...
- If cursor direction is inverted or diagonal, adjust `invert_x`, `invert_y`, or `swap_xy` in `keyboard.toml`. Axes already match stock ZMK (`swap_xy`, `invert_x`, `invert_y`).
